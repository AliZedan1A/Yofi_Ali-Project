...
namespace Yofi_ASP_Net.Global
{
    ...
    class Encreption
    {
        ...
        public static EncinreptionpoeRes<string> En_Code(string words)
        {
            try
            {
        ...
        public static EncinreptionpoeRes<string> De_Code(string words)
        {
            try
            {
    ...
    public class Hasher
    {
        private static string password_1 = "Look Its YoFi And He Is Aaying !#25#%$^";
